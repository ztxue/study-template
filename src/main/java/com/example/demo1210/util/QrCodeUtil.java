...
public class QrCodeUtil {
     ...
     * @param outStream 输出流
     */
    public static void writeToFile(BitMatrix matrix, String format, OutputStream outStream) throws IOException {
...
//        g.drawRoundRect(x, y, logoImage.getWidth(), logoImage.getHeight(), 10, 10);
    ...
    //生成二维码图片
    public static  void createQrCodeImage(String content,String path,String fileName){
        String format = "jpg";
        int width = 220;
        int height = 220;
        ...
        try {
            ...
            writeToFile(bitMatrix, format, outStream);
            outStream.close();
        } catch (Exception e) {
            e.printStackTrace();
        }finally {
...
//        pressText(text, withTextPath, path, fontStyle, Color.BLUE, fontSize, width, height);
    ...
    public static void main(String[] args){
        ...
        String path = "D:/Test/";
        String fileName = "bbb";
        QrCodeUtil.createQrCodeImage(content,path,fileName);
